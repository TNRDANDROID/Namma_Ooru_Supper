...
import com.nic.nammaoorusuper.activity.ViewNutriGarden;
...
public class NutriGardernDetailsServerAdapter extends RecyclerView.Adapter<NutriGardernDetailsServerAdapter.MyViewHolder> {
    ...
    public NutriGardernDetailsServerAdapter(Activity context, List<NOS> pendingListValues, dbData dbData) {
